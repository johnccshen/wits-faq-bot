...
class FaqBot:
    ...
    def ask(
        ...
        if '很抱歉，我無法回答以上問題，請聯絡8855。' in response_message:
            ...
            is_succeed = False
        if not is_succeed:
            recommend_questions, _ = self.strings_ranked_by_relatedness(query, df, top_n=1)
            ...
            if "Please contact 8855" in response_message:
                recommend_strings = "These are the recommended FAQ"
                ...
                recommend_strings = response["choices"][0]["text"]
